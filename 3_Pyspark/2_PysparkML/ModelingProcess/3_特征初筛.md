...
class SparkPreprocessing(object):
    ...
    @classmethod
    def pipline(cls, df, distinct_count_thresh=32, na_prop_thresh=0.9, iv_thresh=0.1, _id='id', _label='label'):
 ...
    def distinct_count(self, thresh=32):
        # countDistinct bug???
        ...
        return self.df.select([j for i, j in ls if 1 < i < thresh] + self.id_label)
